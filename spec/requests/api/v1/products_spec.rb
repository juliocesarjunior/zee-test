...
RSpec.describe 'api/v1/products', type: :request do
    ...
    path '/produtos' do
        ...
        get('list products') do
            ...
            parameter name: :'q[name_or_description_cont]', in: :query, type: :string, description: 'Busca por Produtos (nome ou descrição)'
            ...
            response(200, 'successful') do
                ...
                examples RequestProductHelpers.products_example
